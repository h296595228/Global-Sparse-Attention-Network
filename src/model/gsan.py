...
def make_model(args, parent=False):
    if args.dilation:
        ...
        return GSAN(args, dilated.dilated_conv)
    else:
        return GSAN(args)
...
class GSAN(nn.Module):
    def __init__(self, args, conv=common.default_conv):
        ...
        # define body module
        m_body = [attention.GlobalSparseAttention(
        ...
        for i in range(n_resblock):
            ...
            if (i+1)%8==0:
                m_body.append(attention.GlobalSparseAttention(
                    channels=n_feats, chunk_size=args.chunk_size, n_hashes=args.n_hashes, reduction=4, res_scale=args.res_scale))
